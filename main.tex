...
\begin{figure}[t]
    ...
    \caption{Distribution of fitness effects for 144 head ablations at four representative checkpoints. Histograms (bars), fitted Student's t (black), fitted Normal (red dashed). \textbf{At step 512}, the distribution is dominated by a narrow peak at zero with two outliers; the Student's t AIC advantage ($\Delta$AIC = +140) reflects outlier capture, not distribution shape. \textbf{By step 2 000}, a continuous heavy-tailed distribution has emerged. \textbf{At step 16 000 and step 143 000}, the Student's t form with strong negative skew matches the universal DFE shape reported across biological and engineered adaptive systems [Paper 1]. The gamma shape $\beta$ of the deleterious tail evolves from $\beta$ = 1.77 [95 % CI: 1.23, 2.84] at step 512 into the biological range (E. coli $\beta$ $\approx$ 0.5, yeast $\beta$ $\approx$ 0.7) by step 1 000 and remains there. Titles report n_diff (heads above threshold 5$\times$10⁻⁴), Gini, skewness, and kurtosis.}
...
\begin{figure}[t]
    ...
    \caption{\textbf{(a)} $\Delta$AIC of Student's t and Laplace distributions relative to Normal, at each checkpoint. Positive values indicate better fit than Normal. Student's t decisively wins at every checkpoint ($\Delta$AIC ≫ 10 throughout), confirming non-Gaussian shape. \textbf{(b)} Gamma shape parameter $\beta$ of the deleterious tail (|$\Delta$| > 10⁻⁴ to exclude numerical noise), with 2 000-sample bootstrap 95 % CI. $\beta$ = 1.77 at step 512 is in the light-tailed regime; the drop to $\beta$ $\approx$ 0.8 at step 1 000 is significant (non-overlapping CIs). Subsequent evolution to $\beta$ $\approx$ 0.6 at step 143 000 matches the biological range marked with dashed lines.}
...
Analysis was conducted with extensive use of Claude (Anthropic) as a thinking and implementation partner. Computation was performed on Google Colab Pro (NVIDIA A100 40~GB).
...
Layer/Head & L8H9 & L4H6 & L0H9 & L1H6 & L12H0 & L16H15 & L7H0 & L13H6 & L8H6 \\
$|\Delta|$ & 0.154 & 0.027 & 0.0085 & 0.0071 & 0.0063 & 0.0056 & 0.0055 & 0.0051 & 0.0049 \\
Ratio to top-1 & 1.000 & 0.176 & 0.055 & 0.046 & 0.041 & 0.037 & 0.036 & 0.033 & 0.032 \\
\bottomrule
\end{tabular}
\end{table}
