...
Analysis was conducted with extensive use of Claude (Anthropic) as a thinking and implementation partner. Computation was performed on Google Colab Pro (NVIDIA A100 40~GB). The main ablation sweep (1{,}584 ablations) completed in 82 minutes; Tier 1 replication experiments (seed-robustness, cross-dataset L8H9, bootstrap convergence, drift monitoring) added approximately 40 additional minutes.
